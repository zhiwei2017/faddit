...
.. list-table::
   ...
   * - **/api/v1/subfeddits/**
     - Getting brief information of subfeddits.
   * - **/api/v1/subfeddit/**
     - Get detailed information of a specific subfeddit.
   * - **/api/v1/comments/**
     - Get comments of a specific subfeddit.
...
Comment
~~~~~~~
It represents a comment, contains:

+ **id**: unique identifier of the comment.
+ **username**: user, who made/wrote the comment.
+ **text**: content of the comment in free text format.
+ **created_at**: timestamp in unix epoch time, when the comment was made.

Subfeddit
~~~~~~~~~

It's a subreddit like schema, contains:

+ **id**: unique identifier if the subfeddit
...
* **Zhiwei Zhang** - *Maintainer* - `zhiwei2017@gmail.com <mailto:zhiwei2017@gmail.com?subject=[GitHub]Fake%20reddit%20API>`_
