...
import click
import logging
from feddit.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("feddit.app.utils.logging.click.style",
    ...
    @mock.patch("feddit.app.utils.logging.logging.Formatter")
